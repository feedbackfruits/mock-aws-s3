...
S3Mock.prototype = {
	...
	listObjects: function (search, callback) {
		...
		var files = walk('Prefix' in search ? search.Bucket + '/' + search.Prefix.slice(0, -1) : search.Bucket);
		...
		if (search.Marker) {
			...
			var marker = search.Bucket  + '/' + search.Marker.slice(0, -1);
